...
describe('Werewolf', function() {
  ...
  it('should start off not hungry', function() {
    var werewolf = new Werewolf('Sebastian', 'Gusto');
  ...
  it('should be able to eat(victim) once hungry', function() {
    var werewolf = new Werewolf("Gregory", "place");
    var victim = new Victim('Billy');
  ...
  it('should not be hungry after changing back to human form', function() {
    var werewolf = new Werewolf("Mikey", "Cemetery");
  ...
  it('should not be able to consume victim in human form', function() {
    var werewolf = new Werewolf("Scruffy", "Lunar surface");
    var victim = new Victim("Shepherd");

    assert.equal(werewolf.eat(victim), "Cannibalism is not allowed");
  });
});
